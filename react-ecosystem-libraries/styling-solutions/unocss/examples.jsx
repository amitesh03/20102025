...
// UnoCSS Examples - Educational Examples for UnoCSS
// Note: UnoCSS is an instant, atomic CSS engine with a focus on performance and extensibility

export default function UnoCSSExamples() {
  const [activeExample, setActiveExample] = useState('basics');

  return (
    <div className="examples-container">
      <h1>UnoCSS Examples</h1>
      <p className="intro">
        UnoCSS is an instant, atomic CSS engine with a focus on performance and extensibility. It provides on-demand utilities and is highly customizable.
      </p>
...
function BasicsExample() {
  return (
    <div className="example-section">
      <h2>UnoCSS Basics</h2>
      <p>Getting started with UnoCSS utility classes.</p>
...
# Install preset for common utilities
...
export default defineConfig({
  presets: [
    ...
    presetWind(), // Tailwind CSS compatible preset
  ],
...
<div className="flex items-center justify-center p-4">
  <h1 className="text-2xl font-bold text-primary">Hello UnoCSS</h1>
</div>
...
function LayoutExample() {
  return (
    <div className="example-section">
      <h2>Layout with UnoCSS</h2>
      <p>Creating layouts with UnoCSS utilities.</p>
...
function TypographyExample() {
  return (
    <div className="example-section">
      <h2>Typography with UnoCSS</h2>
      <p>Styling text with UnoCSS utilities.</p>
...
function ColorsExample() {
  return (
    <div className="example-section">
      <h2>Colors with UnoCSS</h2>
      <p>Using colors in UnoCSS.</p>
...
function AnimationsExample() {
  return (
    <div className="example-section">
      <h2>Animations with UnoCSS</h2>
      <p>Creating animations with UnoCSS utilities.</p>
...
function CustomizationExample() {
  return (
    <div className="example-section">
      <h2>Customization in UnoCSS</h2>
      <p>Customizing UnoCSS to fit your needs.</p>
...
export default defineConfig({
  rules: [
    ...
    // Custom colors
    [/^text-custom-(.+)$/, ([, color]) => ({ color: color })],
    [/^bg-custom-(.+)$/, ([, color]) => ({ 'background-color': color })],
    
    // Custom utilities
    ['custom-shadow', { 'box-shadow': '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)' }],
    ['custom-gradient', { 'background-image': 'linear-gradient(to right, #007bff, #6f42c1)' }],
...
// Usage
<div className="m-10 p-20">Custom margins and padding</div>
<div className="text-custom-#ff6b6b">Custom text color</div>
<div className="bg-custom-#4ecdc4">Custom background color</div>
<div className="custom-shadow p-4">Custom shadow</div>
<div className="custom-gradient text-white p-4">Custom gradient</div>
...
.m-10 { margin: 10px; }
.p-20 { padding: 20px; }
.text-custom-\#ff6b6b { color: #ff6b6b; }
.bg-custom-\#4ecdc4 { background-color: #4ecdc4; }
.custom-shadow { box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); }
.p-4 { padding: 1rem; }
.custom-gradient { background-image: linear-gradient(to right, #007bff, #6f42c1); }
.text-white { color: white; }
...
// Usage
<div className="u-flex u-items-center u-justify-center u-p-4">
  <h1 className="u-text-2xl u-font-bold u-text-primary">Hello UnoCSS</h1>
</div>
...
.w-btn { padding: 1rem 1.5rem; border-radius: 0.25rem; font-weight: 500; transition-property: color, background-color, border-color, text-decoration-color, fill, stroke; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1); transition-duration: 150ms; }
.w-btn-primary { background-color: #007bff; color: white; }`}
        </pre>
      </div>
    </div>
  );
